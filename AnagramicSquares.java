...
public class AnagramicSquares
{
    ...
    public AnagramicSquares()
    {
        ...
        {
            min = i;
            for(int x = i +1; x < wln; x++)
            {
                if(words[x].length() < words[min].length())
                {
                    min = x;
                }
            }
    ...
    public ArrayList sort(ArrayList<String> AL)
    {
        String temp = "";
    ...
    public ArrayList addList(char[] arr)
    {
        ArrayList<String> temp = new ArrayList<String>(0);
        for(int i = 0 ; i < arr.length; i ++)
